...
![697](./Attachments/agents-forget-1776198335551.png){/* IMAGE: hero diagram showing the 4 strategies side by side as mental models — baseline (messages dropping off the front), sliding window (fixed-size window), summary (messages collapsing to a bullet), scratchpad (messages flowing into an external box) */}
