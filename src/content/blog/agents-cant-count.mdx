...
**Repo info** fetches metadata. Descri;ption, stars, license, topics. The kind of thing you'd see on the repo's landing page.
...
"How many test functions in test_options.py?" Five answers: 53, 42, 16, 34, 75. Truth: 80. Zero correct.
